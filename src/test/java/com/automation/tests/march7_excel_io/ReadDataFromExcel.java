package com.automation.tests.march7_excel_io;
...
public class ReadDataFromExcel {
    ...
    // DON'T WORRY ABOUT QUESTION MARK ?
    ...
    public void readExcelFileTest() throws Exception{
       ...
       // object that represents excel file
        ...
        for (int i = 0; i <lastCell ; i++) {
            System.out.print(firstRow.getCell(i) + " | ");  //to print it like a table
        }
        ...
        // return how many rows at all
        int numberOfRows2 = workSheet.getPhysicalNumberOfRows();

        System.out.println("\nNumber of last row : " + numberOfRows);//  \n --> add new line
        System.out.println("\nNumber of all rows in total : " + numberOfRows2);
